...
public class Profil extends Fragment {
    ...
    public void change_pass(){
        ...
        if(passe.equals("") || passeConfirm.equals("")){
            Toast.makeText(getContext(), "Champs obligatoires pour modifier le mot de passe", Toast.LENGTH_LONG).show();
        } else {
            if(!passe.equals(passeConfirm)){
                Toast.makeText(getContext(), "Le nouveau mot de passe et sa confirmation ne sont pas identiques.", Toast.LENGTH_LONG).show();
            } else {
